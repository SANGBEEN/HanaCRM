				...
				<ul class="nav pull-right">
					...
					<li class="dropdown hidden-phone">
						<a class="btn dropdown-toggle" data-toggle="dropdown" href="#">
							...
							<span class="badge badge-important">${sessionScope.reservationCount}</span>
						</a>
...
<script>
	...
	/* $.ajax({
		...
		success: function(reservationList){
			html = '<li class="dropdown-menu-title"><span>${sessionScope.reservationCount}개의 신청 내역</span>
				'<a href="#refresh"><i class="icon-repeat"></i></a></li><li>'+
                   '<a href="#">'+
