...
<head>
	...
	<link rel="stylesheet" href="${pageContext.request.contextPath}/css/assets/css/bootstrap.min.css" />
	<link rel="stylesheet" href="${pageContext.request.contextPath}/css/assets/font-awesome/4.5.0/css/font-awesome.min.css" />

	<!-- page specific plugin styles -->

	<!-- text fonts -->
	<link rel="stylesheet" href="${pageContext.request.contextPath}/css/assets/css/fonts.googleapis.com.css" />

	<!-- ace styles -->
	<link rel="stylesheet" href="${pageContext.request.contextPath}/css/assets/css/ace.min.css" class="ace-main-stylesheet" id="main-ace-style" />

	<!--[if lte IE 9]>
		<link rel="stylesheet" href="${pageContext.request.contextPath}/css/assets/css/ace-part2.min.css" class="ace-main-stylesheet" />
	<![endif]-->
	<link rel="stylesheet" href="${pageContext.request.contextPath}/css/assets/css/ace-skins.min.css" />
	<link rel="stylesheet" href="${pageContext.request.contextPath}/css/assets/css/ace-rtl.min.css" />

	<!--[if lte IE 9]>
	  <link rel="stylesheet" href="${pageContext.request.contextPath}/css/assets/css/ace-ie.min.css" />
	<![endif]-->

	<!-- inline styles related to this page -->

	<!-- ace settings handler -->
	<script src="${pageContext.request.contextPath}/css/assets/js/ace-extra.min.js"></script>

	<!-- HTML5shiv and Respond.js for IE8 to support HTML5 elements and media queries -->

	<!--[if lte IE 8]>
	<script src="${pageContext.request.contextPath}/css/assets/js/html5shiv.min.js"></script>
	<script src="${pageContext.request.contextPath}/css/assets/js/respond.min.js"></script>
	<![endif]-->
</head>
<body class="no-skin">
							...
							<div class="hide message-content" id="id-message-content">
								<div class="message-header clearfix">
									<div class="pull-left">
										...
										&nbsp;
										<img class="middle" alt="John's Avatar" src="${pageContext.request.contextPath}/css/assets/images/avatars/avatar.png" width="32" />
										&nbsp;
								...
								<div class="message-attachment clearfix">
									...
									<div class="attachment-images pull-right">
										...
										<div>
											<img width="36" alt="image 4" src="${pageContext.request.contextPath}/css/assets/images/gallery/thumb-4.jpg" />
											<img width="36" alt="image 3" src="${pageContext.request.contextPath}/css/assets/images/gallery/thumb-3.jpg" />
											<img width="36" alt="image 2" src="${pageContext.request.contextPath}/css/assets/images/gallery/thumb-2.jpg" />
											<img width="36" alt="image 1" src="${pageContext.request.contextPath}/css/assets/images/gallery/thumb-1.jpg" />
										</div>
									</div>
								</div>
							</div><!-- /.message-content -->
	...
	<!--[if !IE]> -->
	<script src="${pageContext.request.contextPath}/css/assets/js/jquery-2.1.4.min.js"></script>

	<!-- <![endif]-->

	<!--[if IE]>
<script src="${pageContext.request.contextPath}/css/assets/js/jquery-1.11.3.min.js"></script>
<![endif]-->
	<script type="text/javascript">
		if('ontouchstart' in document.documentElement) document.write("<script src='${pageContext.request.contextPath}/css/assets/js/jquery.mobile.custom.min.js'>"+"<"+"/script>");
	</script>
	<script src="${pageContext.request.contextPath}/css/assets/js/bootstrap.min.js"></script>

	<!-- page specific plugin scripts -->
	<script src="${pageContext.request.contextPath}/css/assets/js/bootstrap-tag.min.js"></script>
	<script src="${pageContext.request.contextPath}/css/assets/js/jquery.hotkeys.index.min.js"></script>
	<script src="${pageContext.request.contextPath}/css/assets/js/bootstrap-wysiwyg.min.js"></script>

	<!-- ace scripts -->
	<script src="${pageContext.request.contextPath}/css/assets/js/ace-elements.min.js"></script>
	<script src="${pageContext.request.contextPath}/css/assets/js/ace.min.js"></script>
