															...
															<div class="row">
																<div class="col-xs-12 col-sm-2">
																	<div class="text-center">
																		<img height="150" class="thumbnail inline no-margin-bottom" alt="Domain Owner's Avatar" src="${pageContext.request.contextPath}/assets/images/avatars/profile-pic.jpg" />
																		<br />
