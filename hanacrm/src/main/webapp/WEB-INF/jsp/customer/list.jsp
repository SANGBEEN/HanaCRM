...
<body>
				...
				<div class="row-fluid">
					<div class="box span12">
						<div class="box-header" data-original-title>
							<h2>고객 리스트</h2>
							<div class="box-icon">
								<a id="addModal" style="cursor: pointer;"> <i
								...
								<form class="form-horizontal"
									...
									<div class="form-group">
										<div class="col-sm-12 text-right"
											style="margin: 30px auto; padding-right: 20px">
											<button class="btn customer-submit-btn" id="submitBtn" type="submit">
												등록<i class="fa fa-check spaceLeft"></i>
											</button>
											<button class="btn customer-cancel-btn" data-dismiss="modal"
												aria-hidden="Close">
	...
	<script src="js/KoAddress.js"></script>
